    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="../makina.php">Makina</a></li>
                            ...
                            <div class="active tab-pane" id="activity">
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 class="box-title">
                                            <dt>Women’s Voices ICT Briefing</dt>
                                        </h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <dl>
                                            ...
                                            <dd>There is a gap in gender representation among the people of Kibera in
                                                regards to having the women’s voices heard on issues involving their
                                                community and the society they live in. This project, Women’s Voices,
                                                seeks to capture women’s views and ideas about county development, and
                                                make sure, these ideas are shared with the relevant authorities. It
                                                looks to address four main themes of governance, transparency,
                                                accountability, and anti-corruption. To do this, we plan to train women
                                                in the community to be representatives of the rest of the community,
                                                called women voices champions. These women will be in charge of
                                                collection and analyzing data from and about the community as well as
                                                other administrative work. The women will also be in charge of updating
                                                a dashboard that connects the project to the community and the rest of
                                                the world through social media, and updating the dashboard with real
                                                time information about what is happening in the community. The
                                                information they work to collect and present will be shared with the
                                                relevant county officials, so they can put the community’s thoughts into
                                                action. The women’s voices champions will help to give voice to other
                                                female members of the community whose ideas and opinions may not have
                                                been able to be shared without this project. Women’s Voices will be run
                                                through four of Kibera’s bio-sanitation facilities since they are
                                                already a focal point for men and women in the community.
                                            </dd>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <img class="profile-user-img img-responsive img-circle"
                                                     src="../dist/img/pp.jpg" alt="User profile picture">
                                                ...
                                                <div class="box box-primary">
                                                    ...
                                                    <!-- /.box-header -->
                                                    <div class="box-body">
                                                        <strong><i class="fa fa-university margin-r-1"></i>
                                                            Education</strong>
                                                        ...
                                                        <hr>
                                                        <strong><i class="fa fa-wrench margin-r-5"></i>
                                                            Skills</strong><br>
                            ...
                            <div class="active tab-pane" id="gallery">
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 class="box-title">
                                            <dt>Pictures From Past Events</dt>
                                        </h3>
                                    </div>
                                    <div class="box-body">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <img class="img-responsive" src="../dist/img/makina2.jpeg"
                                                         alt="Photo">
                                                    <br>
                                                    <img class="img-responsive" src="../dist/img/makina3.jpeg"
                                                         alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                                <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="box-body">
                                                            <iframe src="https://www.google.com/maps/d/embed?mid=1P16zI5wBQLpLOjeZ9lpFCWnUYHM"
                                                                    width="340" height="380"></iframe>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <!-- /.box-header -->
                                                        <div class="box-body">
                                                            <strong><i class="fa fa-book margin-r-5"></i> Background
                                                                info</strong>
                                                            ...
                                                            <hr>
                                                            <strong><i class="fa fa-money margin-r-5"></i> Funding
                                                                Agency</strong>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <hr>
                                                            <strong><i
                                                                    class="fa fa-user margin-r-5"></i>Population</strong>
                                                            ...
                                                            <hr>
                                                            <strong><i class="fa fa-list-alt margin-r-5"></i>Mode of
                                                                transport</strong>
