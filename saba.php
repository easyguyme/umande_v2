...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <?php
                $query = $conn->query("select * from ptop where page='saba'");
                        ...
                        <div class="box-body no-padding">
                            <ul class="users-list clearfix">
                                ...
                                while ($row = $query->fetch()) {
                                    ...
                                    ?>
                                    <li>
                                        <img src="saba/champs/<?php echo $row['image']; ?>" alt="User Image">
                    ...
                    <div class="box box-warning direct-chat-warning">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <?php
                                $query = $conn->query("select * from pdes where page='saba'");
                                while ($row = $query->fetch()) {
                        ...
                        <!-- /.box-body -->
                        <div class="box-footer text-center">
                            <a href="profile/lainisaba.html.html" class="uppercase">Read More</a>
                        </div>
                        <!-- /.box-footer-->
                    </div>
                    <!-- /.box -->
            ...
            <div class="row" >
                <div class="col-md-6">
                    <div class="box box-success">
                        ...
                        <?php
                        $query = $conn->query("select * from pieinfo where page='saba'");
                        while ($row = $query->fetch()) {
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_4">
                                                ...
                                                <?php
                                                $query = $conn->query("select * from barinfo where page='saba'");
                                                while ($row = $query->fetch()) {
                                                ...
                                                <div class="box box-solid">
                                                    ...
                                                    while ($row = $query->fetch())
                                                    {
                                                        ...
                                                        if($counter == 0)
                                                        {
                                                            $Indicators .='<li data-target="#carousel-example-generic" data-slide-to="'.$counter.'" class="active"></li>';
                                                            $slides .= '<div class="item active">
            <img src="saba/gallery/'.$image.'" alt="'.$title.'" />
            <div class="carousel-caption">
              <h3>'.$title.'</h3>
              <p>'.$desc.'.</p>
            </div>
              ...
              <p>'.$desc.'.</p>
                                            ...
                                            <div class="tab-pane" id="tab_6">
                                                ...
                                                <div class="box-body">
                                                    <ul class="products-list product-list-in-box">
                                                        <?php
                                                        $query = $conn->query("select * from planned where page='saba'");
                                                        while ($row = $query->fetch()) {
...
<script src="dist/js/pages/lapie.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="dist/js/demo.js"></script>
<script src="dist/js/pages/labar.js"></script>
